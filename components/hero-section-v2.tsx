...
export default function HeroSectionV2() {
  ...
  const benefitsMapping = useMemo(() => [
    ...
    //  AD1 – https://www.instagram.com/p/DJibMCtMrtc/
    {
      id: 30,
      isLogo: true,
      title: <span className={`${isDark ? "text-[#F4F0E1]" : "text-[#07242C]"} text-[30px] md:text-4xl`}>
      Esqueça todas as técnicas, ferramentas e conceitos de negócio.
    </span>,
      text: (
        <span className="text-[20px] md:text-3xl tex">
          <span className={isDark ? "text-[#c0964b]" : "text-[#07242C]"}>A primeira coisa a se fazer para alcançar o sucesso profissional e
          financeiro</span><span className={isDark ? "text-[#F4F0E1]" : "text-[#07242C] font-bold"}> é um diagnóstico de dependência emocional.</span>
        </span>
      ),
    },
  ...
  return (
    <section
      id="hero"
      className={`relative flex md:items-center items-start overflow-hidden mb-[-50px] lg:mb-[-150px] z-0 bg-[#D3CAC0] w-full h-full min-h-screen ${isDark ? "md:bg-[url('/images/v4/SplashScreenV4Dark2.webp')] bg-[url('/images/v4/SplashScreenV4Dark2Mobile.webp')] md:bg-center bg-top bg-cover bg-no-repeat" : "md:bg-[url('/images/v4/SplashScreenV4Ligth2.webp')] bg-[url('/images/v4/SplashScreenV4Ligth2Mobile.webp')] md:bg-center bg-top bg-cover bg-no-repeat"}`}
    >
      <div className="container mx-auto px-4 pb-4 pt-4 md:pt-16 relative">
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-12 z-[0]">
          {/* Coluna da esquerda - Formulário */}
          <div className="w-full max-w-xl mb-0 text-center md:text-left">
            {isLogo && (
              <div className="flex justify-center ml-8 md:ml-0">
                <Image
                  src={isDark ? "/images/Lettering_ORO_V2.webp" : "/images/Lettering_ORO_DARK_V2.webp"}
            ...
            <div className="md:my-4 my-4 text-center max-w-xl">
              {!titleRedLine ? (
                <>
            ...
            <p className="text-[#f4f0e1]/80 text-center md:mb-8 mb-6 max-w-xl mx-auto md:mx-0">
              {redLine ? (
            ...
            <div className="text-[#f4f0e1] max-w-xl text-base md:text-lg md:mb-4 mb-4 font-medium text-center">
              <span className={isDark ? "text-[#f4f0e1]" : "text-[#07242C]"}>
                Preencha os dados abaixo para fazer o seu diagnóstico  de bloqueio de permissão gratuito
              </span>
            </div>
            <form
            ...
            >
              ...
              <button
                type="submit"
                className="w-full text-white font-medium py-3 px-6 rounded-full transition-all hover:brightness-110 uppercase text-sm tracking-wider"
                style={{
                  border: "2px solid rgba(0, 76, 70, 1)",
                  background: "radial-gradient(42.75% 101.03% at 50% 50%, #007B80 0%, rgba(0, 76, 70, 1) 100%)",
                  boxShadow: "0px 4px 24px 0px #004C4626",
                }}
            ...
            {/* <p className="text-white text-xs md:text-lg mt-4 text-center md:text-left flex items-center justify-center gap-2">
            ...
            <div className={`border-t ${isDark ? "border-white/20" : "border-[#07242C]"} my-10 w-full`}/>
            <div className={`text-${isDark ? "white" : "[#07242c]"} text-center flex flex-col items-center justify-center text-[12px]`}>
              <p>
